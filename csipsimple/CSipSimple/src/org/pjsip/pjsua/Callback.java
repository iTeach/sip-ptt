...
public class Callback {
  ...
  public void on_zrtp_show_sas(int data, pj_str_t sas, int verified) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_zrtp_show_sas(swigCPtr, this, data, pj_str_t.getCPtr(sas), sas, verified); else pjsuaJNI.Callback_on_zrtp_show_sasSwigExplicitCallback(swigCPtr, this, data, pj_str_t.getCPtr(sas), sas, verified);
  }

  public void on_zrtp_update_transport(int data) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_zrtp_update_transport(swigCPtr, this, data); else pjsuaJNI.Callback_on_zrtp_update_transportSwigExplicitCallback(swigCPtr, this, data);
  }
